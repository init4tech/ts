...
Generate TypeScript code for creating and signing Signet orders using @signet-sh/sdk.
...
1. Import from `@signet-sh/sdk` using explicit type imports where appropriate
...
```typescript
import { UnsignedOrder, MAINNET, orderHash } from "@signet-sh/sdk";
...
```typescript
import { UnsignedFill, MAINNET, type Output } from "@signet-sh/sdk";
import { createWalletClient, http } from "viem";
import { privateKeyToAccount } from "viem/accounts";
import { mainnet } from "viem/chains";
...
```typescript
import { orderHash, orderHashPreImage, type SignedOrder } from "@signet-sh/sdk";
...
```typescript
import { UnsignedOrder, PARMIGIANA, orderHash } from "@signet-sh/sdk";
import { createWalletClient, http } from "viem";
import { privateKeyToAccount } from "viem/accounts";
...
```typescript
import { UnsignedOrder, MAINNET, orderHash, type Input, type Output } from "@signet-sh/sdk";
import { createWalletClient, http } from "viem";
import { privateKeyToAccount } from "viem/accounts";
import { mainnet } from "viem/chains";
