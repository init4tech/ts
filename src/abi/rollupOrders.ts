/**
 * RollupOrders contract ABI.
 * Generated from crates/zenith/abi/RollupOrders.json
 */
export const rollupOrdersAbi = [
  {
    type: "constructor",
  ...
  },
  {
    ...
    inputs: [
      { name: "tokenRecipient", type: "address", internalType: "address" },
      {
        name: "outputs",
        type: "tuple[]",
        internalType: "struct IOrders.Output[]",
