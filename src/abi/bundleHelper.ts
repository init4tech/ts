...
export const bundleHelperAbi = [
  {
    type: "constructor",
    inputs: [
      { name: "_zenith", type: "address", internalType: "address" },
      { name: "_orders", type: "address", internalType: "address" },
    ],
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: "", type: "address", internalType: "contract HostOrders" },
    ],
  ...
  },
  {
    ...
    name: "zenith",
    inputs: [],
    outputs: [{ name: "", type: "address", internalType: "contract Zenith" }],
    stateMutability: "view",
  },
] as const;
